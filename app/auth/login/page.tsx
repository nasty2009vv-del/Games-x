    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0a0b10] relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-950 border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-3 font-light">مرحباً بعودتك إلى الاستوديو</p>
        </div>
        ...
        <form className="space-y-6">
          ...
          <div>
            <div className="flex justify-between mb-2">
              <Link href="#" className="text-xs text-purple-500 hover:text-purple-400 font-black">نسيت كلمة المرور؟</Link>
              <label className="text-sm font-black text-slate-400">كلمة المرور</label>
            </div>
            <input 
              type="password" 
              placeholder="••••••••"
        ...
        <div className="relative my-8">
           ...
           <div className="relative flex justify-center text-xs font-black text-slate-600"><span className="bg-slate-950 px-4">أو تابع عبر</span></div>
        </div>
        ...
        <button className="w-full bg-slate-900 border border-slate-800 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-800 transition-all mb-8">
           <span className="text-lg">حساب GitHub</span>
        </button>

        <div className="text-center text-sm">
           <span className="text-slate-500">ليس لديك حساب؟ </span>
           <Link href="/auth/signup" className="text-purple-500 font-black hover:text-purple-400 underline underline-offset-4">أنشئ حسابك الآن</Link>
        </div>
      </div>
    </div>
  );
